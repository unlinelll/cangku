...
# 24 "corelist.h"
typedef struct Student { char name [32]; int age; } datatype;
...
static Node * list_find(Node * head , datatype * find_data , 
# 39 "corelist.h" 3 4
                                                            _Bool 
# 39 "corelist.h"
                                                                 (* equal)(datatype * p1,datatype * p2));
...
_Bool 
# 11 "08_内核链表.c"
    Judge_data(datatype * p1 ,datatype * p2);
...
# 77 "08_内核链表.c"
    ...
    printf("请输入姓名:\n");
    fgets(ptr->name,sizeof(ptr->name),
# 82 "08_内核链表.c" 3 4
                                     stdin
# 82 "08_内核链表.c"
                                          );
